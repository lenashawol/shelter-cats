...
Shelter Cats é um jogo de digitação onde a velocidade e habilidade do jogador (usuário) são recompensadas com pontos, que, no jogo, aparecem como ajuda e alimento para gatinhos que vivem em um abrigo. O sistema conta com autenticação de usuários, placares e rankings em ligas, onde o jogador pode competir com seus amigos e demais usuários. A interface foi projetada para ser amigável e fofa, utilizando uma paleta de cores pastéis e um design coeso em todas as telas, para trazer ao jogador uma experiência agradável e que condiz com o tema.
